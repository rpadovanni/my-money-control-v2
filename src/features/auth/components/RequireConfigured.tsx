    ...
    <div className="mx-auto max-w-5xl p-4">
      <header className="mb-4">
        ...
        <p className="text-base-content/70">
          Configuração necessária para usar a versão em nuvem.
        </p>
      </header>
      <section className="card border border-base-300 bg-base-100">
        <div className="card-body">
          ...
          <p className="text-base-content/70">
            Para usar rotas protegidas (login obrigatório), defina as variáveis
          ...
          <p className="text-base-content/70">
            Depois reinicie o <code>pnpm dev</code>. O passo a passo está em{" "}
            <code>README.md</code> e <code>docs/supabase-cloud-mvp.md</code>.
          </p>
        </div>
      </section>
    </div>
